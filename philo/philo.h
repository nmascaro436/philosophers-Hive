...
int					create_philo_threads(t_simulation *data, t_philo *philo,
						pthread_t *philo_thr);
int					monit_thr(t_simulation *data, t_philo *philo,
						pthread_t *philo_thr, pthread_t *monitor);
void				join_threads(pthread_t *philo, int count, pthread_t *monit,
						int monit_cr);
